...
var _AUTOMATIC_PROCESS_AND_PLAY:bool = true
...
func _ready() -> void:
	...
	if _AUTOMATIC_PROCESS_AND_PLAY:
		automatic_generation_set_and_play_on_ready()
	pass
...
func automatic_generation_set_and_play_on_ready() -> void:
	if _NODE_IS_READY:
		generate_set_and_play_forward(true)
		_AUTOMATIC_PROCESS_AND_PLAY = false
	else:
		_AUTOMATIC_PROCESS_AND_PLAY = true
	pass
