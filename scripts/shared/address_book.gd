...
const INSPECTOR = {
	...
	"NODE": {
		...
		"PROPERTIES": {
			...
			"NODE_IS_SKIPED_CHECK": "/root/Main/FloatToolsLayer/Container/Inspector/VBoxContainer/TabContainer/Node/Properties/NodeState/NodeIsSkiped",
...
const QUERY = {
	...
	"MATCHS_OPTION_BUTTON": "/root/Main/Editor/Bottom/QueryPanel/HBoxContainer/Matchs",
